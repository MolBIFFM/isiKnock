 ...
 */
public class ChangeNameDialog extends JEDialog {
     ...
     * @param modal
     */
    public ChangeNameDialog(String oldName, java.awt.Frame parent, boolean modal) {
        super(parent, modal);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ChangeNameDialog dialog = new ChangeNameDialog("test" ,new javax.swing.JFrame(), true);
